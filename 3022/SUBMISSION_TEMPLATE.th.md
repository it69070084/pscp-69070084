...
```text
input : รับค่าอุณหภูมิ
output : แสดงค่าอุณหภูมิที่แปลงแล้ว
```
...
```text
Step 1 : รับค่าตัวเลข
Step 2 : รับค่าตัวอักษร
Step 3 : ตรวจสอบตัวอักษร
Step 4 : แปลงค่าตัวเลข
Step 5 : แสดงค่าตัวเลข
```
...
```text
0 CELSIUS เป็นค่ามาตรฐานสากลที่ง่ายต่อการตรวจสอบ
```
...
```text
-40 เป็นอุณหภูมิพิเศษที่เป็นจุดบรรจบกันพอดีระหว่างหน่วยฟาเรนไฮต์และเซลเซียส
```
