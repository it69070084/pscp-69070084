...
```text
Step 1 : รับค่าความเร็วและจำนวนบ้าน
Step 2 : หาพิกัดบ้าน
Step 3 : แสดงค่าบ้านหารด้วยความเร็วแล้วจึงปัดขึ้น
Step 4 : ลูปจนกว่าจะครบ
```
...
```text
เขียนโค้ดออกมาในแบบที่ตนเองเข้าใจ
```
