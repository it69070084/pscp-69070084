...
```text
input : รับค่า
output : แสดงค่า "Surprising" หรือ "Not surprising"
```
...
```text
Step 1 : รับค่าจำนวนจริง
Step 2 : หาค่าเฉลี่ย
Step 3 : หาส่วนต่าง
Step 4 : ตรวจสอบเงื่อนไข
Step 5 : แสดงค่า "Surprising" หรือ "Not surprising"
```
...
```text
Step 1 : รับค่าจำนวนจริง
Step 2 : คะแนนของสองคนที่เหลือ
Step 3 : หาคะแนนที่ต่ำที่สุด
Step 4 : หาส่วนต่าง
Step 5 : ตรวจสอบเงื่อนไข
Step 6 : แสดงค่า "Surprising" หรือ "Not surprising"
```
