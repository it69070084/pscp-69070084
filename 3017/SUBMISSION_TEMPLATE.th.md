...
```
input : รับคำ
output : ค่าที่คำนวนค่าบริการและภาษาแล้ว
constraints : อ่านโจทย์ไม่เข้าใจ
```
...
```
Step 1:รับค่า
Step 2:หาค่าบริการ แล้วจึงไปหาผลรวมภาษี
Step 3:แปลงเป็นทศนิยมสองตำแหน่ง
Step 4:แสดงผล
```
...
```
หาค่าบริการ แล้วจึงหาค่าภาษีจากผลรวมของค่าบริการ จากนั้นจึงไปรวมกันอีกที
```
